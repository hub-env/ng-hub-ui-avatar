...
> **⚠️ CAMBIOS QUE ROMPEN COMPATIBILIDAD:** la 22.15.0 respeta un `size` que ya trae unidades en
> lugar de convertirlo en píxeles: `size="1.75rem"` se componía como `1.75rempx`, que el navegador
> descarta sin avisar, y el avatar se quedaba sin caja. Un número suelto sigue siendo píxeles; el
> getter `avatarSizePx` se sustituye por la señal `avatarSize()`.
> La 22.14.0 deja de pintar todas las iniciales en
...
| `size`           | `number \| string`                                                | `50`        | Tamaño del avatar: un número suelto son px; cualquier longitud CSS (`1.75rem`, `50%`, `calc(2rem + 12px)`) se pinta tal cual                                                                                                                                                                                                                                                                                                                                                                                               |
